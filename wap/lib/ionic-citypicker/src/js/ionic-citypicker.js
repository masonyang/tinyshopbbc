...
app.directive('ionicCityPicker', ['$ionicPopup', '$timeout','CityPickerService','$ionicScrollDelegate','$ionicModal', function ($ionicPopup, $timeout,CityPickerService, $ionicScrollDelegate,$ionicModal) {
  ...
  return {
    ...
    link: function (scope, element, attrs) {
        ...
        vm.onRelease = function (name) {
            switch (name) {
                case 'province':
                    var Handle = vm.provinceHandle;
                    break
                case 'city':
            ...
            vm.runing = $timeout(function () {
                ...
                $ionicScrollDelegate.$getByHandle(Handle).scrollTo(0, top + 0.1, true)
            }, 10)
        }
        ...
        vm.AreaService = angular.isDefined(so.CityPickerService) ? so.CityPickerService : CityPickerService
        vm.tag = so.tag || "-"
