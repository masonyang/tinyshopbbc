...
//        'customer_count'=>array('name'=>'客户统计','parent'=>'count'),
	...
	'nodes'=>array(
		'/admin/index'=>array('name'=>'管理首页','parent'=>'config'),
        '/admin/theme_list'=>array('name'=>'主题设置','parent'=>'config'),
        '/admin/config_globals_headstore'=>array('name'=>'站点设置','parent'=>'config'),
        '/admin/config_other_headstore'=>array('name'=>'其它配置','parent'=>'config'),
        '/admin/config_email_headstore'=>array('name'=>'邮箱配置','parent'=>'config'),
...
//        '/count/user_reg'=>array('name'=>'会员分布统计','parent'=>'customer_count'),
       ...
       // '/marketing/bundling_edit'=>array('name'=>'编辑捆绑促销','parent'=>'promotions'),
        ...
        '/orderscanner/scannersetting_list'=>array('name'=>'扫描枪设置','parent'=>'scannersetting'),
        '/orderscanner/scannersetting_add'=>array('name'=>'扫描枪(新增/编辑)','parent'=>'scannersetting'),
        '/orderscanner/scannerorder'=>array('name'=>'单据扫描','parent'=>'order'),
	),
);
