...
class wpcarts extends baseapi
{
    ...
    public static $notice = array(
        'addcart'=>'<span style="color: red;"></span>',
        'docheckout'=>'',
        'checkout'=>'',
        'scount'=>'<span style="color: red;"></span>',
        'cindex'=>'<span style="color: red;"></span>',
        'removecart'=>'<span style="color: red;"></span>',
        'changecheckout'=>'<span style="color: red;"></span>',
    );
    ...
    public static $requestUrl = array(
        'addcart'=>'     /index.php?con=api&act=index&method=wpcarts&source=addcart',
        'docheckout'=>'     /index.php?con=api&act=index&method=wpcarts&source=docheckout',
        'checkout'=>'     /index.php?con=api&act=index&method=wpcarts&source=checkout',
        'scount'=>'     /index.php?con=api&act=index&method=wpcarts&source=scount',
        'cindex'=>'     /index.php?con=api&act=index&method=wpcarts&source=cindex',
        'removecart'=>'     /index.php?con=api&act=index&method=wpcarts&source=removecart',
        'changecheckout' =>'     /index.php?con=api&act=index&method=wpcarts&source=changecheckout',
    );
