...
class wpattention extends baseapi
{
    ...
    public static $requestUrl = array(
        'list'=>'     /index.php?con=api&act=index&method=wpattention&source=list',
        'add'=>'     /index.php?con=api&act=index&method=wpattention&source=add',
        'cancel'=>'     /index.php?con=api&act=index&method=wpattention&source=cancel',
    );
