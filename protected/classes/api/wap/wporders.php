...
class wporders extends wapbase
{
    ...
    public static $requestUrl = array(
        'orderdetail'=>'     /index.php?con=api&act=index&method=wporders&source=orderdetail',
        'morders'=>'     /index.php?con=api&act=index&method=wporders&source=morders',
        'ordercancel'=>'     /index.php?con=api&act=index&method=wporders&source=ordercancel',
    );
    ...
    protected function orderDetail()
    {
        ...
        $data['payment_id'] = (int)$orders['payment'];
        $data['payment'] = ($orders['payment'] == 8) ? '微信公众号支付' : '支付宝[手机支付]';
