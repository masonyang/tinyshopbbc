...
class wpcustomer extends wapbase
{
    ...
    public static $requestUrl = array(
        'login'=>'     /index.php?con=api&act=index&method=wpcustomer&source=login',
        'register'=>'     /index.php?con=api&act=index&method=wpcustomer&source=register',
        'address'=>'     /index.php?con=api&act=index&method=wpcustomer&source=address',
        'addaddr'=>'     /index.php?con=api&act=index&method=wpcustomer&source=addaddr',
        'doaddr'=>'     /index.php?con=api&act=index&method=wpcustomer&source=doaddr',
        'uinfo'=>'     /index.php?con=api&act=index&method=wpcustomer&source=uinfo',
        'forgetpwd'=>'     /index.php?con=api&act=index&method=wpcustomer&source=forgetpwd',
    );
    ...
    protected function login()
    {
        ...
        if(isset($this->params['smscode'])){
            ...
            $md5 = 'wapsmscode'.$this->params['rand'];
